...
*/
  ...
  app.post('/create_pad', function(request, response) {
    ...
    pg.connect(process.env.DATABASE_URL, function(err, client, done) {
      save_or_update_pad_query = 'INSERT INTO pad (title,last_modified_timestamp,last_modified_user) VALUES (\'' + chimpad_pad_title + '\', NOW() ,' + chimpad_pad_user + '\'' + chimpad_pad_type +'\' ) RETURNING id;';
